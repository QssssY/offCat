...
class MockInterviewAiServiceImplTest {
    ...
    void shouldAppendStructuredImmediateFeedbackForMockReply() {
        ...
        String reply = service.generateReply("session-4", List.of(), "我的回答", "java", "Java工程师", 2, null, "immediate", "normal", 0);
    ...
    void shouldAppendTechLeaderPersonaForMockReply() {
        ...
        String reply = service.generateReply("session-5", List.of(), "我的回答", "java", "Java工程师", 2, null, "after_interview", "tech_leader", 0);
