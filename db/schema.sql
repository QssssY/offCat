...
CREATE TABLE `user_quota` (
  ...
  `interview_quota` INT NOT NULL DEFAULT 100 COMMENT 'Remaining interview quota',
  `resume_quota` INT NOT NULL DEFAULT 100 COMMENT 'Remaining resume quota',
  ...
  `free_polish_left` INT NOT NULL DEFAULT 100 COMMENT '非会员免费润色剩余',
  `free_jd_match_left` INT NOT NULL DEFAULT 100 COMMENT '非会员免费JD匹配剩余',
  `free_template_left` INT NOT NULL DEFAULT 100 COMMENT '非会员免费模板剩余',
  `free_offer_left` INT NOT NULL DEFAULT 100 COMMENT '非会员免费Offer剩余',
