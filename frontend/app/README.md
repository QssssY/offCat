...
offcat 前端应用，基于 Vue 3 构建，提供 AI 简历诊断、模拟面试（含语音交互）、JD 匹配、AI 简历润色、简历模板编辑、社区交流、用户设置、Offer 助手、成长中心、自定义 AI 引擎配置及完整的管理后台等功能。
...
- Node.js >= 18
- 后端服务运行在 `localhost:8080`（详见 offcat 根目录 README）
